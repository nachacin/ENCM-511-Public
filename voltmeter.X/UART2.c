...
///// Xmit UART2: 
///// Displays 'CharNum' on realterm 'repeatNo' of times using UART to PC. 
...
void XmitUART2(char CharNum, unsigned int repeatNo) {	
    ...
    //Turn off UART2 upon transmission of last character; also can be Verified in interrupt subroutine U2TXInterrupt()
